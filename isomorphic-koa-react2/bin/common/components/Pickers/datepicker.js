...
var DatePicker = function (_React$Component) {
    ...
    */
		...
		_this.state = {
			isPickerShow: false,
			valueGroups: _helpers.DateUtils.toValueGroupsNoTime(_this.props.date),
			optionGroups: _helpers.DateUtils.toOptionGroupsNoTime(_this.props.date)
		};
		return _this;
	}
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(_reactMobilePicker2.default, { ref: 'picker', optionGroups: optionGroups, valueGroups: valueGroups, onChange: this.handleChange })
					)
				)
			);
		}
