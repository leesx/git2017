...
var FoodCategoryPicker = function (_React$Component) {
	_inherits(FoodCategoryPicker, _React$Component);

	function FoodCategoryPicker(props) {
		_classCallCheck(this, FoodCategoryPicker);

		var _this = _possibleConstructorReturn(this, (FoodCategoryPicker.__proto__ || Object.getPrototypeOf(FoodCategoryPicker)).call(this, props));

		_this.sendRequest = function () {
			_helpers.SiteInfo.getSiteInfo(function () {
				var foodCategoryList = _helpers.SiteInfo.info.FDTypeLst;
				var optionsGroupTitle = ["菜品分类名称"];
				foodCategoryList.map(function (elem) {
		...
		_this.handleChange = function (name, value) {
			...
			try {
				for (var _iterator = _this.state.foodCategoryList[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
					var obj = _step.value;
			...
			if ((typeof v === 'undefined' ? 'undefined' : _typeof(v)) != undefined) {
				_this.props.refreshFoodCategory(v);
			}
		};
	...
	_createClass(FoodCategoryPicker, [{
		key: 'render',
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(_reactMobilePicker2.default, { optionGroups: optionGroups, valueGroups: valueGroups, onChange: this.handleChange })
					)
				)
			);
		}
	...
	return FoodCategoryPicker;
}(_react2.default.Component);

exports.default = FoodCategoryPicker;