...
var ChannelPicker = function (_React$Component) {
  _inherits(ChannelPicker, _React$Component);

  function ChannelPicker(props) {
    _classCallCheck(this, ChannelPicker);

    var _this = _possibleConstructorReturn(this, (ChannelPicker.__proto__ || Object.getPrototypeOf(ChannelPicker)).call(this, props));

    _initialiseProps.call(_this);

    var channelData = _this.getChannelData(_this.props.channelList);
    _this.state = _extends({}, channelData, {
      isPickerShow: false
    });
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.componentWillReceiveProps = function (nextProps) {
    if (_this2.props.channelList != nextProps.channelList) {
      var channelData = _this2.getChannelData(nextProps.channelList);
      _this2.setState(_extends({}, channelData));
    }
  };

  this.getChannelData = function (channelLists) {

    var channelList = channelLists || [];

    var optionsGroupTitle = ["渠道名称"];
    channelList.map(function (elem) {
  ...
  this.handleChange = function (name, value) {
    ...
    try {
      for (var _iterator = _this2.state.channelList[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        var obj = _step.value;
