...
var BillStatusPicker = function (_React$Component) {
  _inherits(BillStatusPicker, _React$Component);

  function BillStatusPicker(props) {
    _classCallCheck(this, BillStatusPicker);

    var _this = _possibleConstructorReturn(this, (BillStatusPicker.__proto__ || Object.getPrototypeOf(BillStatusPicker)).call(this, props));
    ...
    _this.handleChange = function (name, value) {
      ...
      if ((typeof v === 'undefined' ? 'undefined' : _typeof(v)) != undefined) {
        _this.props.refreshBillStatus(v);
      }
    };
    ...
    _this.state = {
      ...
      optionGroupsObjList: [{ key: "账单状态", value: "10" }, { key: "全部", value: "10" }, { key: "待结账", value: "20" }, { key: "已作废", value: "30" }, { key: "已结账", value: "40" }]
    };
  ...
  return BillStatusPicker;
}(_react2.default.Component);

exports.default = BillStatusPicker;